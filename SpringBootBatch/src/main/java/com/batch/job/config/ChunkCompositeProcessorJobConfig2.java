...
public class ChunkCompositeProcessorJobConfig2
{

	private final Logger log = LoggerFactory.getLogger(ChunkCompositeProcessorJobConfig2.class);
	private final String JOB_NAME = "ChunkCompositeProcessor2";
