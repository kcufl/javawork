...
import com.kcufl.comm.MessageManager;
...
public class JsonParseJobConfig
{

	private final Logger log = LoggerFactory.getLogger(JsonParseJobConfig.class);
	private final String JOB_NAME = "JsonParse";
	...
	public ItemProcessor<HashMap<String, Object>, HashMap<String, Object>> processor()
	{
		...
		return new ItemProcessor<HashMap<String, Object>, HashMap<String, Object> >()
		{
			...
			public HashMap<String, Object> process(HashMap<String, Object> member) throws Exception
			{
				...
				String inputMessage = messageManager.parsingInputMessage("M030",test);

				String message = "               kcufl41male  ";

				Map ouputMessage = messageManager.parsingOutputMessage("M030",message);

				log.info("inputMessage :: [" + inputMessage + "]");
				log.info("ouputMessage :: [" + ouputMessage + "]");
